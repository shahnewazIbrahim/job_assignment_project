...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset('owlcarousel/css/owl.theme.default.min.css') }}"
    />
    <!-- Magnific Popup CSS -->
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              <div class="widget">
                <div class="footer_logo">
                  <a href="#"
                    ><img src="{{ asset('images/logo_light.png') }}" alt="logo"
                  /></a>
                </div>
                <p>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <ul class="footer_payment text-center text-lg-end">
                ...
                <li>
                  <a href="#"
                    ><img src="{{ asset('images/discover.png') }}" alt="discover"
                  /></a>
                </li>
                <li>
                  <a href="#"
                    ><img src="{{ asset('images/master_card.png') }}" alt="master_card"
                  /></a>
                </li>
                <li>
                  <a href="#"
                ...
                <li>
                  <a href="#"
                    ><img
                      src="{{ asset('images/amarican_express.png') }}"
    ...
    <script>
        ...
        function addToCart(productId) {
            ...
            .then(function (response) {
                alert(response.data.message); // অথবা sweetalert/toast ব্যবহার করো
            })
