            ...
            >
              <div class="lng_dropdown me-2">
                <select name="countries" class="custome_select">
                  <option
                    value="en"
                    data-image="{{ asset('images/eng.png') }}"                      data-title="English"
                  >
                    English
                  </option>
                  <option
                    value="fn"
                    data-image="{{ asset('images/fn.png') }}"                      data-title="France"
                  >
                    France
                  </option>
                  <option
                    value="us"
                    data-image="{{ asset('images/us.png') }}"                      data-title="United States"
                  >
                    United States
                  </option>
                </select>
